...
3. 两种经济学的根本区别`,
  quizzes: [
    ...
    { id: 'pe-q-01-01b', type: 'choice', question: '政治经济学的研究对象是（）', options: ['生产力', '生产关系', '上层建筑', '意识形态'], answer: '生产关系', explanation: '政治经济学研究社会生产关系及其发展规律，这是与西方经济学的根本区别。' },
...
4. 商品价值量与劳动生产率的关系（计算题）`,
  quizzes: [
    { id: 'pe-q-02-01a', type: 'choice', question: '商品的本质因素是（）', options: ['使用价值', '价值', '交换价值', '价格'], answer: '价值', explanation: '价值是商品的本质因素，体现商品生产者之间的社会关系。使用价值是商品的自然属性，但不是本质因素。' },
    ...
    { id: 'pe-q-02-01d', type: 'choice', question: '社会必要劳动时间是指（）', options: ['个别生产者耗费的劳动时间', '社会平均的劳动时间', '在现有社会正常生产条件下，社会平均劳动熟练程度和强度下制造某种使用价值所需的时间', '最先进生产者耗费的劳动时间'], answer: '在现有社会正常生产条件下，社会平均劳动熟练程度和强度下制造某种使用价值所需的时间', explanation: '社会必要劳动时间的三个条件：现有社会正常生产条件、社会平均劳动熟练程度、社会平均劳动强度。' },
  ],
...
4. 结合现实分析价值规律的作用（如产能过剩、技术竞争等）`,
  quizzes: [
    { id: 'pe-q-02-02a', type: 'choice', question: '价值规律的表现形式是（）', options: ['价格等于价值', '价格围绕价值上下波动', '价格决定价值', '价值决定价格'], answer: '价格围绕价值上下波动', explanation: '价格受供求关系影响围绕价值上下波动，这是价值规律的表现形式。' },

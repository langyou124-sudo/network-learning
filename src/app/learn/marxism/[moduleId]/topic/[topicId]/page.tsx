...
export default function MarxismTopicPage() {
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-2 text-[13px] text-[var(--text-muted)] mb-5 animate-in">
        <Link href="/learn/marxism" className="hover:text-[var(--accent)] transition-colors">马克思主义基本原理</Link>
        <span className="opacity-40">/</span>
        <Link href={`/learn/marxism/${moduleId}`} className="hover:text-[var(--accent)] transition-colors">{module.title}</Link>
        <span className="opacity-40">/</span>
      ...
      {activeTab === 'notes' && (
        <div className="card px-4 sm:px-8 py-4 sm:py-8 animate-in">
          ...
          <textarea
            ...
            style={{ border: '1.5px solid var(--border)', background: 'var(--surface)', lineHeight: '1.8' }}
          />

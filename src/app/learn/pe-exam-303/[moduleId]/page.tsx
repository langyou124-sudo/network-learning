...
export default function PeExam303ModulePage() {
  ...
  return (
    <div>
      <div className="mb-8 animate-in">
        <Link href="/learn/pe-exam-303" className="text-[13px] text-[var(--accent)] hover:underline">← 返回303数学三</Link>
      ...
      {topics.length > 0 ? (
        <div className="space-y-3">
          {topics.map((topic, index) => (
            <Link
              key={topic.id}
              href={`/learn/pe-exam-303/${moduleId}/topic/${topic.id}`}
